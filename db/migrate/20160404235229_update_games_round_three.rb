class UpdateGamesRoundThree < ActiveRecord::Migration
	def up
		# # round 1
		...
		#final 4
		Game.create(:slot => 60, :team1 => Team.find_by_slot(14), :team2 => Team.find_by_slot(30), :team1_score => 100, :team2_score => 0) #Vill. W OU
		Game.create(:slot => 61, :team1 => Team.find_by_slot(32), :team2 => Team.find_by_slot(61), :team1_score => 100, :team2_score => 0) #UNC W Syr
		
		#Title game
		Game.create(:slot => 62, :team1 => Team.find_by_slot(14), :team2 => Team.find_by_slot(32), :team1_score => 100, :team2_score => 0) #Vill W UNC
