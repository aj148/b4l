class UpdateGames < ActiveRecord::Migration
	def up
		...
		Game.create(:slot => 36, :team1 => Team.find_by_slot(16), :team2 => Team.find_by_slot(19), :team1_score => 100, :team2_score => 0) #Ore W SJ
		...
		# # round 3
		# Game.create(:slot => 48, :team1 => Team.find_by_slot(0), :team2 => Team.find_by_slot(4), :team1_score => 100, :team2_score => 0)
		# Game.create(:slot => 49, :team1 => Team.find_by_slot(10), :team2 => Team.find_by_slot(14), :team1_score => 100, :team2_score => 0)

		# Game.create(:slot => 50, :team1 => Team.find_by_slot(16), :team2 => Team.find_by_slot(22), :team1_score => 0, :team2_score => 100)
		# Game.create(:slot => 51, :team1 => Team.find_by_slot(26), :team2 => Team.find_by_slot(30), :team1_score => 0, :team2_score => 100)
		
		# Game.create(:slot => 52, :team1 => Team.find_by_slot(32), :team2 => Team.find_by_slot(36), :team1_score => 100, :team2_score => 0)
		# Game.create(:slot => 53, :team1 => Team.find_by_slot(40), :team2 => Team.find_by_slot(44), :team1_score => 0, :team2_score => 100)
		
		# Game.create(:slot => 54, :team1 => Team.find_by_slot(48), :team2 => Team.find_by_slot(54), :team1_score => 100, :team2_score => 0)
		# Game.create(:slot => 55, :team1 => Team.find_by_slot(57), :team2 => Team.find_by_slot(61), :team1_score => 0, :team2_score => 100)
